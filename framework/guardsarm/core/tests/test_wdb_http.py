...
import pytest
from guardsarm.core.wdb_http import AgentsSummary, APPLICATION_JSON, GuardSarmDBHTTPClient
from guardsarm.core.exception import GuardSarmError


class TestGuardSarmDBHTTPClient:
    """Test the functionality of the `GuardSarmDBHTTPClient` class."""
    ...
    @pytest.fixture
    def module_instance(self, client_mock: AsyncMock) -> GuardSarmDBHTTPClient:
        """Provide an instance of VulnerabilityModule with a mocked client for testing."""
        client = GuardSarmDBHTTPClient()
        client._client = client_mock
        return client

    async def test__get(self, client_mock: AsyncMock, module_instance: GuardSarmDBHTTPClient):
    ...
    async def test__get_ko(self, client_mock: AsyncMock, module_instance: GuardSarmDBHTTPClient):
        ...
        expected_error_msg = 'Error 2012 - Invalid guardsarm-manager-db HTTP request: Service Unavailable: failure'
        with pytest.raises(GuardSarmError, match=expected_error_msg):
            await module_instance._get('/agents')
    
    async def test__post(self, client_mock: AsyncMock, module_instance: GuardSarmDBHTTPClient):
    ...
    async def test__post_ko(self, client_mock: AsyncMock, module_instance: GuardSarmDBHTTPClient):
    ...
    async def test_get_agent_groups(self, client_mock: AsyncMock, module_instance: GuardSarmDBHTTPClient):
    ...
    async def test_get_agents_summary(self, client_mock: AsyncMock, module_instance: GuardSarmDBHTTPClient):
    ...
    async def test_get_agents_sync(self, client_mock: AsyncMock, module_instance: GuardSarmDBHTTPClient):
    ...
    async def test_set_agents_sync(self, client_mock: AsyncMock, module_instance: GuardSarmDBHTTPClient):

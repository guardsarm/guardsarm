...
from guardsarm_testing.tools.certificate_controller import CertificateController
...
def generate_ca_certificate(test_metadata):
    ...
    """
    SSL_AGENT_CA = os.path.join(os.environ.get('INSTALLDIR', '/var/guardsarm-manager'), 'etc', 'test_rootCA.pem')

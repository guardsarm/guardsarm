...
from guardsarm_testing.modules.fim.patterns import EVENT_TYPE_DELETED, INODE_ENTRIES_PATH_COUNT
...
def test_delete_multiple_files(test_configuration, test_metadata, set_guardsarm_configuration, truncate_monitored_files,

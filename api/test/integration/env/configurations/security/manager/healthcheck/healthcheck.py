...
def get_master_health():
    os.system("/var/guardsarm-manager/bin/guardsarm-manager-control status > /tmp_volume/daemons.txt")
...
if __name__ == "__main__":
    ...
    exit(get_master_health()) if socket.gethostname() == 'guardsarm-master' else exit(0)

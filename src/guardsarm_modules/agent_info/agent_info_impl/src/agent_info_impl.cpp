...
{
    {FIM_NAME, {"guardsarm-states-fim-files", "guardsarm-states-fim-registry-keys", "guardsarm-states-fim-registry-values"}},
    {SCA_WM_NAME, {"guardsarm-states-sca"}},
    {
...
void AgentInfoImpl::populateAgentMetadata()
{
    ...
    agentMetadata["agent_version"] = __guardsarm_version;

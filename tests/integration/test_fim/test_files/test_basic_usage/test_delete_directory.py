...
from guardsarm_testing.modules.fim.patterns import EVENT_TYPE_DELETED, EVENT_TYPE_MODIFIED
...
def test_delete_dir(test_configuration, test_metadata, set_guardsarm_configuration, configure_local_internal_options,
                    truncate_monitored_files, folder_to_monitor, file_to_monitor, daemons_handler, start_monitoring):
    '''
    description: Check if the 'guardsarm-syscheckd' daemon detects 'deleted' events from the files contained

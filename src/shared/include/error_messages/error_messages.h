...
/* Modules messages */
#define GM_UPGRADE_JSON_PARSE_ERROR                 "(8101): Cannot parse JSON: '%s'"
#define GM_UPGRADE_UNDEFINED_ACTION_ERRROR          "(8102): No action defined for command: '%s'"
#define GM_UPGRADE_COMMAND_PARSE_ERROR              "(8103): Error parsing command: '%s'"
#define GM_UPGRADE_UNREACHEABLE_TASK_MANAGER        "(8104): Cannot connect to '%s'. Could not reach task manager module."
#define GM_UPGRADE_INVALID_TASK_MAN_JSON            "(8105): Response from task manager does not have a valid JSON format."
#define GM_UPGRADE_TASK_EMPTY_MESSAGE               "(8106): Empty message from task manager module."
#define GM_UPGRADE_REQUIRED_PARAMETERS              "(8107): Required parameters in message are missing."
#define GM_UPGRADE_BIND_SOCK_ERROR                  "(8108): Unable to bind to socket '%s': '%s'"
#define GM_UPGRADE_SELECT_ERROR                     "(8109): Error in select(): '%s'. Exiting..."
#define GM_UPGRADE_ACCEPT_ERROR                     "(8110): Error in accept(): '%s'"
#define GM_UPGRADE_RECV_ERROR                       "(8111): Error in recv(): '%s'"
#define GM_UPGRADE_SOCKTERR_ERROR                   "(8112): Response size is bigger than expected."
#define GM_UPGRADE_QUEUE_FD                         "(8113): Could not open default queue to send upgrade notification."
#define GM_UPGRADE_UNREACHEABLE_REQUEST             "(8114): Cannot connect to '%s'. Could not reach agent."
#define GM_UPGRADE_EMPTY_AGENT_RESPONSE             "(8115): Response from agent is empty."
#define GM_UPGRADE_AGENT_RESPONSE_MESSAGE_ERROR     "(8116): Error response from agent: '%s'"
#define GM_UPGRADE_AGENT_RESPONSE_UNKNOWN_ERROR     "(8117): Unknown error from agent."
#define GM_UPGRADE_AGENT_RESPONSE_SHA1_ERROR        "(8118): The SHA1 of the file doesn't match in the agent."
#define GM_UPGRADE_TASK_UPDATE_ERROR                "(8119): There has been an error updating task state. Error code: '%d', message: '%s'"
#define GM_UPGRADE_RESULT_FILE_ERROR                "(8120): Agent was unable to erase upgrade_result file. Reason: '%s'"
#define GM_UPGRADE_AGENT_RESPONSE_SCRIPT_ERROR      "(8121): Script execution failed in the agent."
#define GM_UPGRADE_UPGRADE_QUEUE_FULL               "(8122): Upgrade queue is full. Agent '%d' won't be upgraded."
#define GM_UPGRADE_TASK_MANANAGER_ERROR             "(8123): There has been an error executing the request in the tasks manager."
#define GM_UPGRADE_FILE_OPENED                      "(8124): At %s: File '%s' was opened. Closing."
#define GM_UPGRADE_UNSUPPORTED_MODE                 "(8125): At %s: Unsupported mode."
#define GM_UPGRADE_INVALID_FILE_NAME                "(8126): At %s: Invalid file name."
#define GM_UPGRADE_FILE_NOT_OPENED_AUTO             "(8127): At %s: File not opened. Agent might have been auto-restarted during upgrade."
#define GM_UPGRADE_DIFFERENT_FILE                   "(8128): At %s: The target file doesn't match the opened file '%s'"
#define GM_UPGRADE_CANNOT_WRITE                     "(8129): At %s: Cannot write on '%s'"
#define GM_UPGRADE_FILE_NOT_OPENED                  "(8130): At %s: No file is opened."
#define GM_UPGRADE_GERENIC_ERROR                    "(8131): At %s: '%s'"
#define GM_UPGRADE_GENERATING_SHA1_ERROR            "(8132): At %s: Error generating SHA1."
#define GM_UPGRADE_UNMERGING_FILE_ERROR             "(8133): At %s: Error unmerging file: '%s'"
#define GM_UPGRADE_CHMOD_ERROR                      "(8134): At %s: Could not chmod '%s'"
#define GM_UPGRADE_COMMAND_ERROR                    "(8135): At %s: Error executing command [%s]"
#define GM_UPGRADE_ERASE_FILE_ERROR                 "(8136): At %s: Could not erase file '%s'"
#define GM_UPGRADE_TOO_LONG_TEMP_FILE               "(8137): At %s: Too long temp file."
#define GM_UPGRADE_COMPRESSED_FILE_ERROR            "(8138): At %s: Could not create temporary compressed file."
#define GM_UPGRADE_UNSIGN_FILE_ERROR                "(8139): At %s: Could not unsign package file '%s'"
#define GM_UPGRADE_FILE_OPEN_ERROR                  "(8140): At %s: Unable to open '%s'"
#define GM_UPGRADE_CANNOT_READ                      "(8141): At %s: Unable to read '%s'"

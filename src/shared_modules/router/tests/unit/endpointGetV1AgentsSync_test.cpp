...
#include "shared_modules/router/src/guardsarm-db/endpointGetV1AgentsSync.hpp"
...
TEST_F(EndpointGetV1AgentsSyncTest, HappyPath)
{
    ...
    EXPECT_EQ(
        res.body,
        R"({"syncreq":[{"id":1,"name":"value","ip":"value","os_name":"value","os_version":"value","os_major":"value","os_minor":"value","os_type":"value","os_platform":"value","os_arch":"value","version":"value","merged_sum":"value","node_name":"value","last_keepalive":1,"connection_status":"value","disconnection_time":1,"group_config_status":"value","status_code":1}],"syncreq_keepalive":[{"id":1,"version":"value"}],"syncreq_status":[{"id":1,"version":"value","connection_status":"value","disconnection_time":1,"status_code":1}]})");

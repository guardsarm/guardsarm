...
def test_dapi_allower_sync_function():
    ...
    assert hasattr(test_function, "__guardsarm_exposed__")
    assert test_function.__guardsarm_exposed__ is True
...
def test_dapi_allower_direct_call():
    ...
    assert hasattr(decorated, "__guardsarm_exposed__")
    assert decorated.__guardsarm_exposed__ is True
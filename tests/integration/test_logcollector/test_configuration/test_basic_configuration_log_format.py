...
references:
    ...
    - https://documentation.guardsarm.com/current/user-manual/reference/ossec-conf/localfile.html#log-format
    - https://documentation.guardsarm.com/current/user-manual/reference/ossec-conf/localfile.html#location

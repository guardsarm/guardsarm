...
int main(int argc, char ** argv)
{
    ...
    wconfig.worker_pool_size = getDefine_Int_default("guardsarm_db", "worker_pool_size", 1, 32, 8);
    wconfig.commit_time_min = getDefine_Int_default("guardsarm_db", "commit_time_min", 1, 3600, 10);
    wconfig.commit_time_max = getDefine_Int_default("guardsarm_db", "commit_time_max", 1, 3600, 60);
    wconfig.open_db_limit = getDefine_Int_default("guardsarm_db", "open_db_limit", 1, 4096, 64);
    nofile = getDefine_Int_default("guardsarm_db", "rlimit_nofile", 1024, 1048576, 458752);

    wconfig.fragmentation_threshold = getDefine_Int_default("guardsarm_db", "fragmentation_threshold", 0, 100, 75);
    wconfig.fragmentation_delta = getDefine_Int_default("guardsarm_db", "fragmentation_delta", 0, 100, 5);
    wconfig.free_pages_percentage = getDefine_Int_default("guardsarm_db", "free_pages_percentage", 0, 99, 0);
    wconfig.max_fragmentation = getDefine_Int_default("guardsarm_db", "max_fragmentation", 0, 100, 90);
    wconfig.check_fragmentation_interval = getDefine_Int_default("guardsarm_db", "check_fragmentation_interval", 1, 30758400, 7200);
    ...
    // Read guardsarm configuration file
    if (ReadConfig(modules, GUARDSARMCONF, &gconfig, NULL) < 0) {
        merror_exit("Invalid configuration block for GuardSarm-DB.");
    }

    if (!isDebug()) {
        int debug_level;

        for (debug_level = getDefine_Int_default("guardsarm_db", "debug", 0, 2, 0); debug_level; debug_level--) {
            nowDebug();
        }
    }
    ...
    router_register_api_endpoint("guardsarm-manager-db","wdb-http.sock", "GET", "/v1/agents/ids", (void*)&wdb_global_pre, (void*)&wdb_global_post);
    router_register_api_endpoint("guardsarm-manager-db","wdb-http.sock", "GET", "/v1/agents/ids/groups/:name", (void*)&wdb_global_pre, (void*)&wdb_global_post);
    router_register_api_endpoint("guardsarm-manager-db","wdb-http.sock", "GET", "/v1/agents/ids/groups", (void*)&wdb_global_pre, (void*)&wdb_global_post);
    router_register_api_endpoint("guardsarm-manager-db","wdb-http.sock", "GET", "/v1/agents/:agent_id/groups", (void*)&wdb_global_pre, (void*)&wdb_global_post);
    router_register_api_endpoint("guardsarm-manager-db","wdb-http.sock", "POST", "/v1/agents/summary", (void*)&wdb_global_pre, (void*)&wdb_global_post);
    router_register_api_endpoint("guardsarm-manager-db","wdb-http.sock", "GET", "/v1/agents/sync", (void*)&wdb_global_pre, (void*)&wdb_global_post);
    router_register_api_endpoint("guardsarm-manager-db","wdb-http.sock", "POST", "/v1/agents/sync", (void*)&wdb_global_pre, (void*)&wdb_global_post);
    router_register_api_endpoint("guardsarm-manager-db","wdb-http.sock", "POST", "/v1/agents/restartinfo", (void*)&wdb_global_pre, (void*)&wdb_global_post);

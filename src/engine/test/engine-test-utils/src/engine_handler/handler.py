...
class EngineHandler:
    ...
    def __init__(self, binary_path: str, configuration_path: str, override_env : dict[str, str] = {}):
        ...
        self.api_socket_path = self.config_env.get("GUARDSARM_SERVER_API_SOCKET")
        if self.api_socket_path is None:
            raise KeyError("Environment variable 'GUARDSARM_SERVER_API_SOCKET' not found for the engine configuration")

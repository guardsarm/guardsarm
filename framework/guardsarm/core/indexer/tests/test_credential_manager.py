...
class TestKeystoreClientInit(TestCase):
    ...
    @patch("guardsarm.core.indexer.credential_manager.GuardSarmSocket")
    def test_init_creates_socket_connection(self, mock_socket_class):
        """
        Verify that __init__ successfully creates a GuardSarmSocket connection.
        """
    ...
    def test_init_sets_socket_path(self, mock_socket_class):
        ...
        with patch("guardsarm.core.indexer.credential_manager.KEY_STORE_SOCKET", "/custom/path"):
            client = KeystoreClient()

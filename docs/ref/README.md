...
This Reference Manual describes the GuardSarm Manager (server) component: what it is,
how it is structured, and how to install, configure, operate, and maintain it.

It is organized in the following sections:

- [Description](description.md) — what the GuardSarm Manager is and its role in the platform.

...
try:
    ...
    raise exceptions.GuardSarmIntegrationException(errcode=1003, package=e.name)


class GuardSarmGCloudBucket(GuardSarmGCloudIntegration):
    ...
    def __init__(self, credentials_file: str, logger: logging.Logger, bucket_name: str, prefix: str = None,
        ...
        self.db_path = join(utils.find_guardsarm_path(), "wodles/gcloud/gcloud.db")

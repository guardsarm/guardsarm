...
| Guide | Description |
|-------|-------------|
| [Manager configuration migration](manager-configuration-migration.md) | How to migrate `gsmsec.conf`, `internal_options.conf`, `api.yaml`, and `cluster.json` from 4.x to 5.x |

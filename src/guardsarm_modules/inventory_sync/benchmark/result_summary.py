...
Inputs:
  ...
  --monitor     monitor/guardsarm-manager-modulesd.csv     (from monitor.py)
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--monitor",     required=True, help="Path to process monitor CSV (e.g. monitor/guardsarm-manager-modulesd.csv)")

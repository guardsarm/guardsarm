...
void test_compare_guardsarm_versions_equal_patch(void **state)
{
    (void) state;
    char *v1 = "v4.0.0";
    char *v2 = "v4.0.0";

    int ret = compare_guardsarm_versions(v1, v2, true);

    assert_int_equal(ret, 0);
}

void test_compare_guardsarm_versions_equal_minor(void **state)
{
    (void) state;
    char *v1 = "3.13";
    char *v2 = "3.13";
...
void test_compare_guardsarm_versions_equal_major(void **state)
{
    (void) state;
    char *v1 = "4";
    char *v2 = "v4";
...
void test_compare_guardsarm_versions_greater_patch(void **state)
{
    (void) state;
    char *v1 = "4.0.1";
    char *v2 = "v4.0.0";
...
void test_compare_guardsarm_versions_greater_patch_no_patch(void **state)
{
    (void) state;
    char *v1 = "4.0.1";
    char *v2 = "v4.0.0";

    int ret = compare_guardsarm_versions(v1, v2, false);

    assert_int_equal(ret, 0);
}

void test_compare_guardsarm_versions_greater_minor(void **state)
{
    (void) state;
    char *v1 = "2.15";
    char *v2 = "2";
...
void test_compare_guardsarm_versions_greater_major(void **state)
{
    (void) state;
    char *v1 = "v5";
    char *v2 = "4.9";
...
void test_compare_guardsarm_versions_lower_patch(void **state)
{
    (void) state;
    char *v1 = "v4.0.1";
    char *v2 = "v4.0.3";
...
void test_compare_guardsarm_versions_lower_minor(void **state)
{
    (void) state;
    char *v1 = "2.15.1";
    char *v2 = "2.18";
...
void test_compare_guardsarm_versions_lower_major(void **state)
{
    (void) state;
    char *v1 = "v5";
    char *v2 = "v6.1";
...
void test_compare_guardsarm_versions_null(void **state)
{
    (void) state;
    char *v1 = NULL;
    char *v2 = NULL;
...
void test_compare_guardsarm_versions_long_string_v1(void **state)
{
    (void) state;
    char *v1 = "AAAAAAAAA";
    char *v2 = "v4.0.0";
...
void test_compare_guardsarm_versions_long_string_v2(void **state)
{
    (void) state;
    char *v1 = "v4.0.0";
    char *v2 = "AAAAAAAAA";
...
void test_compare_guardsarm_versions_long_string_both(void **state)
{
    (void) state;
    char *v1 = "BBBBBBBBB";
    char *v2 = "AAAAAAAAA";
...
void test_compare_guardsarm_versions_truncated_version(void **state)
{
    (void) state;
    char *v1 = "v5.123456";
    char *v2 = "v4.0.0";
...
int main(void) {
    const struct CMUnitTest tests[] = {
            ...
            cmocka_unit_test(test_compare_guardsarm_versions_equal_patch),
            cmocka_unit_test(test_compare_guardsarm_versions_equal_minor),
            cmocka_unit_test(test_compare_guardsarm_versions_equal_major),
            cmocka_unit_test(test_compare_guardsarm_versions_greater_patch),
            cmocka_unit_test(test_compare_guardsarm_versions_greater_patch_no_patch),
            cmocka_unit_test(test_compare_guardsarm_versions_greater_minor),
            cmocka_unit_test(test_compare_guardsarm_versions_greater_major),
            cmocka_unit_test(test_compare_guardsarm_versions_lower_patch),
            cmocka_unit_test(test_compare_guardsarm_versions_lower_minor),
            cmocka_unit_test(test_compare_guardsarm_versions_lower_major),
            cmocka_unit_test(test_compare_guardsarm_versions_null),
            cmocka_unit_test(test_compare_guardsarm_versions_long_string_v1),
            cmocka_unit_test(test_compare_guardsarm_versions_long_string_v2),
            cmocka_unit_test(test_compare_guardsarm_versions_long_string_both),
            cmocka_unit_test(test_compare_guardsarm_versions_truncated_version)
    };

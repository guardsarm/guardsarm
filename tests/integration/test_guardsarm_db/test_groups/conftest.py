...
from guardsarm_testing.utils.db_queries.global_db import set_agent_group


# guardsarm-modulesd (wm_database) runs a one-shot synchronization of global.db against
# client.keys and the shared-groups directory roughly 5 seconds after it starts (see
# src/guardsarm_modules/src/wm_database.c). That startup sync deletes every agent that is not

...
def build_payload(target_bytes: int, kind: str = "package") -> dict:
    ...
    Mapping per kind:
      - "package":   guardsarm-states-inventory-packages   (package.*)
      - "system":    guardsarm-states-inventory-system     (host.*)
      - "hotfix":    guardsarm-states-inventory-hotfixes   (package.hotfix.*)
      - "fim_file":  guardsarm-states-fim-files            (file.*)
      - "sca_check": guardsarm-states-sca                  (check.*, policy.*)

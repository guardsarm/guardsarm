...
`engine-bench` is a benchmarking tool designed to evaluate the performance of the GuardSarm engine. It leverages `perf` for performance profiling and generates flame graphs to visualize the performance bottlenecks and hotspots in the engine.
...
## Features
- Performance Profiling: Uses perf to collect performance data for the GuardSarm engine.

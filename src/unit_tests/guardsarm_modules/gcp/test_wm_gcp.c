...
#include "../../wrappers/guardsarm/shared/schedule_scan_wrappers.h"
...
static void test_wm_gcp_pubsub_run_error_running_command(void **state)  {
    ...
    snprintf(gcp_config->credentials_file, OS_SIZE_1024, "/guardsarm/credentials/test.json");
...
static void test_wm_gcp_pubsub_dump_success_logging_debug(void **state) {
    ...
    snprintf(gcp_pubsub_dump_data->config->project_id, OS_SIZE_1024, "guardsarm-gcp-test");
    snprintf(gcp_pubsub_dump_data->config->subscription_name, OS_SIZE_1024, "guardsarm-subscription-test");
    ...
    assert_string_equal(cJSON_GetStringValue(project_id), "guardsarm-gcp-test");
    cJSON *subscription_name = cJSON_GetObjectItem(gcp_pubsub, "subscription_name");
    assert_string_equal(cJSON_GetStringValue(subscription_name), "guardsarm-subscription-test");
    cJSON *credentials_file = cJSON_GetObjectItem(gcp_pubsub, "credentials_file");
    assert_string_equal(cJSON_GetStringValue(credentials_file), "/guardsarm/credentials/test.json");
}
...
static void test_wm_gcp_bucket_run_success(void **state) {
    ...
    snprintf(cur_bucket->credentials_file, OS_SIZE_1024, "/guardsarm/credentials/test.json");
...
static void test_wm_gcp_bucket_dump_success_logging_debug(void **state) {
    ...
    assert_string_equal(cJSON_GetStringValue(bucket), "guardsarm-gcp-test");

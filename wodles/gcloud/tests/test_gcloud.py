...
@patch('gcloud.GuardSarmGCloudSubscriber')
...
@patch('pubsub.subscriber.GuardSarmGCloudSubscriber.check_permissions')
@patch('pubsub.subscriber.GuardSarmGCloudSubscriber.process_messages')

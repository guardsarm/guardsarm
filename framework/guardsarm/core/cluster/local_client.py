...
from guardsarm.core.cluster import client
...
class LocalClient(client.AbstractClientManager):
    ...
    def __init__(self):
        """Class constructor"""
        super().__init__(configuration=guardsarm.core.cluster.utils.read_config(), performance_test=0,
                         concurrency_test=0, file='', string=0, logger=logging.getLogger(), tag="Local Client",
                         cluster_items=guardsarm.core.cluster.utils.get_cluster_items())
    ...
    async def start(self):
        ...
        try:
            ...
            raise exception.GuardSarmInternalError(1119)
        except Exception as e:
            raise exception.GuardSarmInternalError(3009, str(e))
        ...
        while True:
            ...
            try:
                ...
                if min_timeout < self.cluster_items['intervals']['worker']['keep_alive']:
                    raise exception.GuardSarmInternalError(3020)
                else:
                    try:

...
from guardsarm_testing.utils.configuration import get_test_cases_data, load_configuration_template, get_guardsarm_conf
...
def test_indexer(test_configuration, test_metadata, set_guardsarm_configuration, add_configuration,

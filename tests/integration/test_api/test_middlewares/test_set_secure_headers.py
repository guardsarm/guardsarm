...
brief: These tests will check if the set_secure_headers middleware of the API handled by the 'guardsarm-manager-apid' daemon is
       working properly. The GuardSarm API is an open source 'RESTful' API that allows for interaction with the GuardSarm
...
from guardsarm_testing.constants.api import AGENTS_ROUTE, CONFIGURATION_TYPES

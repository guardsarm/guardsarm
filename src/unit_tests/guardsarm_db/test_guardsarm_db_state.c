...
#include "../../guardsarm_db/src/wdb_state.h"
...
void test_guardsarmdb_create_state_json(void** state)
{
...
int main(void)
{
    const struct CMUnitTest tests[] = {
        ...
        cmocka_unit_test_setup_teardown(test_guardsarmdb_create_state_json, test_setup, test_teardown),
    };

...
/* Modules messages */
#define GM_UPGRADE_RESULT_AGENT_INFO         "(8151): Agent Information obtained: '%s'"
#define GM_UPGRADE_MODULE_DISABLED           "(8152): Module Agent Upgrade disabled. Exiting..."
#define GM_UPGRADE_MODULE_FINISHED           "(8154): Module Agent Upgrade finished."
#define GM_UPGRADE_INCOMMING_MESSAGE         "(8155): Incomming message: '%s'"
#define GM_UPGRADE_RESPONSE_MESSAGE          "(8156): Response message: '%s'"
#define GM_UPGRADE_TASK_SEND_MESSAGE         "(8157): Sending message to task_manager module: '%s'"
#define GM_UPGRADE_TASK_RECEIVE_MESSAGE      "(8158): Receiving message from task_manager module: '%s'"
#define GM_UPGRADE_EMPTY_MESSAGE             "(8159): Empty message from local client."
#define GM_UPGRADE_NO_AGENTS_TO_UPGRADE      "(8160): There are no valid agents to upgrade."
#define GM_UPGRADE_DOWNLOADING_WPK           "(8161): Downloading WPK file from: '%s'"
#define GM_UPGRADE_SENDING_WPK_TO_AGENT      "(8162): Sending WPK to agent: '%.3d'"
#define GM_UPGRADE_ACK_MESSAGE               "(8163): Sending upgrade ACK event: '%s'"
#define GM_UPGRADE_ACK_RECEIVED              "(8164): Received upgrade notification from agent '%d'. Error code: '%d', message: '%s'"
#define GM_UPGRADE_REQUEST_SEND_MESSAGE      "(8165): Sending message to agent: '%s'"
#define GM_UPGRADE_REQUEST_RECEIVE_MESSAGE   "(8166): Receiving message from agent: '%s'"
#define GM_UPGRADE_UPGRADE_FILE_AGENT        "(8167): Upgrade result file has been successfully erased from the agent."
#define GM_UPGRADE_TASK_SEND_CLUSTER_MESSAGE "(8168): Sending sendsync message to task manager in master node: '%s'"
#define GM_UPGRADE_DIFF_PACKAGE_NO_FORCE     "(8169): Agent '%d' with platform '%s' won't be upgraded using package '%s' without the force option. Ignoring..."
#define GM_UPGRADE_DIFF_PACKAGE_FORCE        "(8170): Agent '%d' with platform '%s' will be upgraded using package '%s'"
#define GM_UPGRADE_UNSUPPORTED_UPGRADE       "(8171): Agent '%d' with unsupported platform '%s' won't be upgraded without a default package."
#define GM_UPGRADE_UNSUPPORTED_DEFAULT       "(8172): Agent '%d' with unsupported platform '%s' will be upgraded with package '%s'"

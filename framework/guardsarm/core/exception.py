...
from guardsarm.core.cluster import __version__
from guardsarm.core.common import AGENT_NAME_LEN_LIMIT, MAX_GROUPS_PER_MULTIGROUP, MAX_SOCKET_BUFFER_SIZE

GENERIC_ERROR_MSG = "GuardSarm Internal Error. See log for more detail"
DOCU_VERSION = 'current' if __version__ == '' else '.'.join(__version__.split('.')[:2]).lstrip('v')

class GuardSarmException(Exception):
    """
    GuardSarm Exception object.
    """

    ERRORS = {
        # < 999: API
        900: 'One of the API child processes terminated abruptly. The API process pool is not usable anymore. '
             'Please restart the GuardSarm API',
        901: 'API executor subprocess broke. A service restart may be needed',

        # GuardSarm: 0999 - 1099
        999: 'Incompatible version of Python',
        1000: {'message': 'GuardSarm Internal Error',
               'remediation': 'Please, check `GUARDSARM_HOME/logs/guardsarm-manager.log`, `GUARDSARM_HOME/logs/cluster.log` and '
                              '`GUARDSARM_HOME/logs/api.log` to get more information about the error'},
        1001: 'Error importing module',
        1005: {'message': 'Error reading file',
               'remediation': 'Please, ensure you have the right file permissions in GuardSarm directories'},
        1006: {'message': 'File/directory does not exist or there is a problem with the permissions',
               'remediation': 'Please, check if path to file/directory is correct and `guardsarm-manager` '
        ...
        1013: {'message': 'Unable to connect with socket',
               'remediation': 'Please, restart GuardSarm to restore sockets'},
        ...
        1016: {'message': 'Error moving file',
               'remediation': 'Please, ensure you have the required file permissions in GuardSarm directories'},
        1017: 'Some GuardSarm daemons are not ready yet in node "{node_name}" ({not_ready_daemons})',
        1018: 'Body request is not a valid JSON',
        1019: 'Error trying to create backup file',
        1020: {'message': 'Could not find any GuardSarm log file',
               'remediation': 'Please check `GUARDSARM_HOME/logs`'},

        # Configuration: 1100 - 1199
        1101: {'message': 'Requested component does not exist'},
        1102: {'message': 'Invalid section',
               'remediation': f'Please, visit the official documentation (https://documentation.guardsarmsiem.com/'
        ...
        1106: {'message': 'Requested section not present in configuration',
               'remediation': 'Please, check your configuration file. '
                              f'You can visit the official documentation (https://documentation.guardsarmsiem.com/'
                              f'{DOCU_VERSION}/user-manual/reference/ossec-conf/index.html) '
                              'to get more information about configuration sections'},
        ...
        1119: "Directory '/tmp' needs read, write & execution permission for 'guardsarm-manager' user",
        ...
        1124: {'message': 'Remote command detected',
               'remediation': f'To solve this issue, please enable the remote commands in the API settings or add an '
                              f'exception: https://documentation.guardsarmsiem.com/{DOCU_VERSION}/user-manual/api/'
        ...
        1126: {'message': 'Error updating ossec configuration',
               'remediation': 'Please, ensure `GUARDSARM_PATH/etc/guardsarm-manager.conf` has the proper permissions and ownership.'
               },
        1127: {'message': 'Protected section was modified',
               'remediation': 'To solve this, either revert the changes made to this section or disable the protection '
                              'in the API settings: '
                              f"https://documentation.guardsarmsiem.com/{DOCU_VERSION}/user-manual/api/configuration.html"},
        ...
        1129: {'message': 'Higher version agents detected',
               'remediation': f'To solve this issue, please enable agents higher versions in the API settings: '
                              f'https://documentation.guardsarmsiem.com/{DOCU_VERSION}/user-manual/api/'
        ...
        1307: {'message': 'Invalid parameters',
               'remediation': 'Please, check that the update is correct, there is a problem while reading the results, '
                              'contact us at [official repository](https://github.com/guardsarm/guardsarm/issues)'
               },
        ...
        1707: {'message': 'Cannot send request, agent is not active',
               'remediation': 'Please, check non-active agents connection and try again. Visit '
                              f'https://documentation.guardsarmsiem.com/{DOCU_VERSION}/user-manual/registering/index.html and '
                              f'https://documentation.guardsarmsiem.com/{DOCU_VERSION}/user-manual/agents/agent-connection.'
        ...
        1726: {'message': 'GuardSarm authd is not running',
        ...
        1728: {'message': 'Invalid node type',
               'remediation': f'Valid types are `master` and `worker`. Please, visit https://documentation.guardsarmsiem.com/'
        ...
        1730: {'message': 'Node does not exist',
               'remediation': 'Make sure the name is correct and that the node is up. You can check it using '
                              f'`cluster_control -l` (https://documentation.guardsarmsiem.com/{DOCU_VERSION}/user-manual/'
        ...
        1734: {'message': 'Error removing agent from group',
               'remediation': f'Agent does not belong to specified group, to assign the agent to a group follow: '
                              f'https://documentation.guardsarmsiem.com/{DOCU_VERSION}/user-manual/agents/grouping-agents.html'
               },
        ...
        1743: 'Error running GuardSarm syntax validator',
        ...
        2003: {'message': 'Error in guardsarmdb request',
        ...
        2006: {'message': 'Received JSON from GuardSarm DB is not correctly formatted'},
        2007: {'message': 'Error retrieving data from GuardSarm DB'},
        2008: {'message': 'Corrupted RBAC database',
               'remediation': 'Restart the GuardSarm service to restore the RBAC database to default'},
        2009: {'message': 'Pagination error. Response from guardsarm-manager-db was over the maximum socket buffer size'},
        2010: {'message': 'The requested read operation did not complete fully'},
        2011: {'message': 'Could not connect to the guardsarm-manager-db unix socket'},
        2012: {'message': 'Invalid guardsarm-manager-db HTTP request'},
        2013: {'message': 'Error sending HTTP request'},
        2014: {'message': 'The guardsarm-manager-db client connection timeout has been exceeded'},
        2015: {'message': 'Invalid request URL scheme'},
        2016: {'message': 'Invalid unix socket path'},
        2017: {'message': 'Could not retrieve agents synchronization information from guardsarm-manager-db'},
        # Engine:
        ...
        3023: {'message': 'Worker node is not connected to master',
               'remediation': 'Check the cluster.log located at GUARDSARM_HOME/logs/cluster.log file to see if there are '
                              'connection errors. Restart the `guardsarm-manager` service.'},
        3024: "Length of command exceeds limit defined in guardsarm.cluster.common.Handler.cmd_len.",
        3025: {'message': "Could not decrypt message",
               'remediation': "Check the cluster key is correct in the worker's "
                              f"[guardsarm-manager.conf](https://documentation.guardsarmsiem.com/{DOCU_VERSION}/user-manual/reference/"
        ...
        3028: {'message': "Worker node ID already exists",
               'remediation': f"Check and fix [worker names](https://documentation.guardsarmsiem.com/{DOCU_VERSION}/"
                              f"user-manual/reference/ossec-conf/cluster.html#node-name)"
                              " and restart the `guardsarm-manager` service."},
        3029: {"message": "Connected worker with same name as the master",
               "remediation": f"Check and fix the [worker name](https://documentation.guardsarmsiem.com/{DOCU_VERSION}/"
                              f"user-manual/reference/ossec-conf/cluster.html#node-name)"
                              " and restart the `guardsarm-manager` service in the node"},
        3030: {'message': 'Worker does not belong to the same cluster',
               'remediation': f"Change the [cluster name](https://documentation.guardsarmsiem.com/{DOCU_VERSION}/"
                              f"user-manual/reference/ossec-conf/cluster.html#name)"
                              " in the worker configuration to match the master's and restart the `guardsarm-manager` "
                              "service"},
        3031: {'message': "Worker and master versions are not the same",
               'remediation': f"[Update](https://documentation.guardsarmsiem.com/{DOCU_VERSION}/upgrade-guide/index.html)"
        ...
        4000: {'message': "Permission denied",
               'remediation': "Please, make sure you have permissions to execute the current request. "
                              ...
                              f"guardsarmsiem.com/{DOCU_VERSION}/user-manual/api/rbac/configuration.html"},
        ...
        4008: {'message': 'The specified resource is required for a correct GuardSarm\'s functionality'},
        ...
        4019: {'message': 'Invalid resource specified',
               'remediation': f'Please, check the current RBAC resources, for more information please visit https:/'
                              f'/documentation.guardsarmsiem.com/{DOCU_VERSION}/user-manual/api/rbac/configuration.html'},
        ...
        5008: {'message': 'The current user cannot be deleted',
               'remediation': 'You can delete this user with the administrator user (guardsarm) or '
        ...
        6001: {'message': 'Maximum number of requests per minute reached',
               'remediation': f'This limit can be changed in api.yaml file. More information here: https:/'
                              f'/documentation.guardsarmsiem.com/{DOCU_VERSION}/user-manual/api/configuration.html#'
        ...
        6003: {'message': 'Error trying to load the JWT secret',
               'remediation': 'Make sure you have the right permissions: GUARDSARM_PATH/api/configuration/security/'
                              'jwt_secret'},
        6004: {'message': 'The current user does not have authentication enabled through authorization context',
               'remediation': f'You can enable it using the following endpoint: https://documentation.guardsarmsiem.com/'
    ...
    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
        ...
        """Create a GuardSarmException object.
        ...
        dapi_errors : dict
            Dictionary with details about node and logfile. I.e.: {'master-node': {'error': 'GuardSarm Internal error',
            'logfile': GUARDSARM_HOME/logs/api.log}}
        title : str
    ...
    def __eq__(self, other):
        if not isinstance(other, GuardSarmException):
    ...
    def __or__(self, other):
        if isinstance(other, GuardSarmException):
...
class GuardSarmInternalError(GuardSarmException):
    """
    ...
    _default_title = "GuardSarm Internal Error"

    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
                 dapi_errors: dict = None, ids: Union[list, set] = None, title: str = None, type: str = None):
        """Create a GuardSarmInternalError exception.
...
class GuardSarmClusterError(GuardSarmInternalError):
    """
    This type of exception is raised inside the cluster.
    """
    _default_type = "about:blank"
    _default_title = "GuardSarm Cluster Error"


class GuardSarmHAPHelperError(GuardSarmClusterError):
    """
...
class GuardSarmIndexerError(GuardSarmInternalError):
    """Indexer client exception."""

    _default_type = 'about:blank'
    _default_title = 'GuardSarm Indexer Error'


class GuardSarmError(GuardSarmException):
    """
    ...
    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
                 dapi_errors: dict = None, ids: Union[list, set] = None, title: str = None, type: str = None):
        """Create a GuardSarmError exception.
    ...
    def __or__(self, other):
        result: GuardSarmError = super().__or__(other)
        if isinstance(result, GuardSarmError):
...
class GuardSarmPermissionError(GuardSarmError):
    """
...
class GuardSarmResourceNotFound(GuardSarmError):
    """
...
class GuardSarmTooManyRequests(GuardSarmError):
    """
...
class GuardSarmNotAcceptable(GuardSarmError):
    """
...
class IndexerUnavailableError(GuardSarmIndexerError):
    """
    Raised when the indexer is temporarily unavailable after exhausting retries
    """
    _default_type = "about:blank"
    _default_title = "GuardSarm Indexer Unavailable"

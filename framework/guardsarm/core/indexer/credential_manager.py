...
from guardsarm.core.common import KEY_STORE_SOCKET
from guardsarm.core.guardsarm_socket import GuardSarmSocket


class KeystoreClient:
    """
    Client for GuardSarm keystore communication using SizeHeaderProtocol.

    This class manages connection to the GuardSarm keystore socket and provides
    ...
    socket : GuardSarmSocket or None
    ...
    Examples
    --------
    >>> from guardsarm.keystore import KeystoreClient
    ...
    def _connect(self):
        ...
        """
        self.socket = GuardSarmSocket(self.socket_path)

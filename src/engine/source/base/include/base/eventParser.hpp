...
constexpr char EVENT_QUEUE_ID[] {"/guardsarm/protocol/queue"};     ///< JSON pointer for the queue field.
constexpr char EVENT_LOCATION_ID[] {"/guardsarm/protocol/location"}; ///< JSON pointer for the location field.
...
/**
 * @brief Parse an GuardSarm legacy message (4.x) and extract the queue, location and message
 *
 * @param event GuardSarm message
 * @param agentMetadata Agent metadata information
 * @return Event Event object
 * @throw std::runtime_error if the message is not a valid GuardSarm legacy message
...
/**
 * @brief Parse a GuardSarm public message and extract the queue, location and message
 *
 * @param queue GuardSarm message queue
 * @param location GuardSarm message location
 * @param message GuardSarm message content
 * @param agentMetadata Agent metadata information
 * @return Event Event object
 * @throw std::runtime_error if the message is not a valid GuardSarm public message
 * @note The message must be in the format: "queue:location:message"
 */

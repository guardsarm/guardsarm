...
with patch('guardsarmsiem.common.guardsarm_uid'):
    with patch('guardsarmsiem.common.guardsarm_gid'):
        ...
        from guardsarm import task, GuardSarmError
...
@patch('guardsarm.core.utils.GuardSarmDBConnection', return_value=InitWDBSocketMock(sql_schema_file='schema_tasks_test.sql'))
@patch.object(GuardSarmDBQueryTask, '_final_query', fake_final_query)

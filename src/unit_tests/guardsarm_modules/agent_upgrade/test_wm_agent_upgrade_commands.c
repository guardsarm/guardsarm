...
#include "../../wrappers/guardsarm/guardsarm_db/wdb_wrappers.h"
...
int gm_agent_upgrade_analyze_agent(int agent_id, gm_agent_task *agent_task);
int gm_agent_upgrade_validate_agent_task(const gm_agent_task *agent_task);
int gm_agent_upgrade_create_upgrade_tasks(cJSON *data_array, gm_upgrade_command command);
...
static int teardown_agent_status_task_string(void **state) {
    gm_upgrade_agent_status_task *task = state[0];
    char *string = state[1];
...
static int setup_process_hash_table(void **state) {
    setup_hash_table(gm_agent_upgrade_free_agent_task);
    return 0;
}

static int teardown_upgrade_custom_task_string(void **state) {
    teardown_hash_table();
    gm_upgrade_custom_task *task = state[0];
    char *string = state[1];
...
void test_wm_agent_upgrade_cancel_pending_upgrades(void **state)
{
    ...
    cJSON_AddNumberToObject(task_response, "error", GM_UPGRADE_SUCCESS);
    cJSON_AddStringToObject(task_response, "message", upgrade_error_codes[GM_UPGRADE_SUCCESS]);

    // wm_agent_upgrade_parse_task_module_request

    expect_value(__wrap_wm_agent_upgrade_parse_task_module_request, command, GM_UPGRADE_CANCEL_TASKS);
...
void test_wm_agent_upgrade_validate_agent_task_upgrade_ok(void **state)
{
    ...
    char *os_minor = "04";
    char *arch = "x64_86";
    char *guardsarm_version = "v3.13.1";
    ...
    os_strdup(guardsarm_version, agent_task->agent_info->guardsarm_version);
    ...
    will_return(__wrap_wm_agent_upgrade_validate_id, GM_UPGRADE_SUCCESS);

    // wm_agent_upgrade_validate_status

    expect_string(__wrap_wm_agent_upgrade_validate_status, connection_status, status);
    will_return(__wrap_wm_agent_upgrade_validate_status, GM_UPGRADE_SUCCESS);
    ...
    will_return(__wrap_wm_agent_upgrade_validate_system, GM_UPGRADE_SUCCESS);

    // wm_agent_upgrade_validate_version

    expect_string(__wrap_wm_agent_upgrade_validate_version, guardsarm_version, guardsarm_version);
    ...
    will_return(__wrap_wm_agent_upgrade_validate_version, GM_UPGRADE_SUCCESS);

    int ret = gm_agent_upgrade_validate_agent_task(agent_task);
...
void test_wm_agent_upgrade_validate_agent_task_version_err(void **state)
{
    ...
    will_return(__wrap_wm_agent_upgrade_validate_version, GM_UPGRADE_GLOBAL_DB_FAILURE);
...
void test_wm_agent_upgrade_validate_agent_task_system_err(void **state)
{
    ...
    expect_string(__wrap_wm_agent_upgrade_validate_system, arch, arch);
    will_return(__wrap_wm_agent_upgrade_validate_system, "deb");
    will_return(__wrap_wm_agent_upgrade_validate_system, GM_UPGRADE_GLOBAL_DB_FAILURE);
...
void test_wm_agent_upgrade_validate_agent_task_status_err(void **state)
{
    ...
    expect_string(__wrap_wm_agent_upgrade_validate_status, connection_status, status);
    will_return(__wrap_wm_agent_upgrade_validate_status, GM_UPGRADE_AGENT_IS_NOT_ACTIVE);
...
void test_wm_agent_upgrade_validate_agent_task_agent_id_err(void **state)
{
    ...
    expect_value(__wrap_wm_agent_upgrade_validate_id, agent_id, agent);
    will_return(__wrap_wm_agent_upgrade_validate_id, GM_UPGRADE_INVALID_ACTION_FOR_MANAGER);

    int ret = gm_agent_upgrade_validate_agent_task(agent_task);

    assert_int_equal(ret, GM_UPGRADE_INVALID_ACTION_FOR_MANAGER);
}
...
void test_wm_agent_upgrade_analyze_agent_ok(void **state)
{
    ...
    expect_string(__wrap_wm_agent_upgrade_validate_version, guardsarm_version, version);
    expect_string(__wrap_wm_agent_upgrade_validate_version, platform, platform);
    expect_value(__wrap_wm_agent_upgrade_validate_version, command, agent_task->task_info->command);
    will_return(__wrap_wm_agent_upgrade_validate_version, "v4.1.0");
    will_return(__wrap_wm_agent_upgrade_validate_version, GM_UPGRADE_SUCCESS);
    ...
    error_code = gm_agent_upgrade_analyze_agent(agent, agent_task);

    assert_int_equal(error_code, GM_UPGRADE_SUCCESS);
    ...
    assert_string_equal(agent_task->agent_info->guardsarm_version, version);
...
void test_wm_agent_upgrade_analyze_agent_duplicated_err(void **state)
{
    ...
    assert_int_equal(error_code, GM_UPGRADE_UPGRADE_ALREADY_IN_PROGRESS);
    assert_non_null(agent_task->agent_info);
    assert_string_equal(agent_task->agent_info->platform, platform);
    assert_string_equal(agent_task->agent_info->major_version, major);
    assert_string_equal(agent_task->agent_info->minor_version, minor);
...
void test_wm_agent_upgrade_analyze_agent_unknown_err(void **state)
{
    ...
    assert_int_equal(error_code, GM_UPGRADE_UNKNOWN_ERROR);
    assert_non_null(agent_task->agent_info);
    assert_string_equal(agent_task->agent_info->platform, platform);
    assert_string_equal(agent_task->agent_info->major_version, major);
    assert_string_equal(agent_task->agent_info->minor_version, minor);
...
void test_wm_agent_upgrade_analyze_agent_validate_err(void **state)
{
    ...
    assert_int_equal(error_code, GM_UPGRADE_INVALID_ACTION_FOR_MANAGER);
    assert_non_null(agent_task->agent_info);
    assert_string_equal(agent_task->agent_info->platform, platform);
    assert_string_equal(agent_task->agent_info->major_version, major);
    assert_string_equal(agent_task->agent_info->minor_version, minor);
...
void test_wm_agent_upgrade_analyze_agent_global_db_err(void **state)
{
    ...
    assert_int_equal(error_code, GM_UPGRADE_GLOBAL_DB_FAILURE);
    assert_non_null(agent_task->agent_info);
    ...
    assert_null(agent_task->agent_info->guardsarm_version);
}
...
void test_wm_agent_upgrade_create_upgrade_tasks_ok(void **state)
{
    ...
    cJSON_AddStringToObject(task_response, "error", GM_UPGRADE_SUCCESS);
    cJSON_AddStringToObject(task_response, "message", upgrade_error_codes[GM_UPGRADE_SUCCESS]);
    ...
    expect_value(__wrap_wm_agent_upgrade_parse_task_module_request, command, GM_UPGRADE_AGENT_GET_STATUS);
    ...
    expect_value(__wrap_wm_agent_upgrade_parse_task_module_request, command, GM_UPGRADE_UPGRADE_CUSTOM);
    ...
    int ret = gm_agent_upgrade_create_upgrade_tasks(data_array, GM_UPGRADE_UPGRADE_CUSTOM);
...
void test_wm_agent_upgrade_process_upgrade_result_command_ok(void **state)
{
    ...
    cJSON_AddNumberToObject(result_response, "error", GM_UPGRADE_SUCCESS);
    cJSON_AddStringToObject(result_response, "message", upgrade_error_codes[GM_UPGRADE_SUCCESS]);
    ...
    cJSON_AddNumberToObject(response_json, "error", GM_UPGRADE_SUCCESS);
    cJSON_AddStringToObject(response_json, "message", upgrade_error_codes[GM_UPGRADE_SUCCESS]);

    // wm_agent_upgrade_parse_task_module_request

    expect_value(__wrap_wm_agent_upgrade_parse_task_module_request, command, GM_UPGRADE_RESULT);
    ...
    expect_value(__wrap_wm_agent_upgrade_parse_response, error_id, GM_UPGRADE_SUCCESS);
    will_return(__wrap_wm_agent_upgrade_parse_response, response_json);

    char *result = gm_agent_upgrade_process_upgrade_result_command(agents);
...
void test_wm_agent_upgrade_process_agent_result_command_done(void **state)
{
    ...
    upgrade_agent_status_task = gm_agent_upgrade_init_agent_status_task();
    ...
    cJSON_AddNumberToObject(status_response, "error", GM_UPGRADE_SUCCESS);
    cJSON_AddStringToObject(status_response, "message", upgrade_error_codes[GM_UPGRADE_SUCCESS]);
    ...
    char *result = gm_agent_upgrade_process_agent_result_command(agents, upgrade_agent_status_task);
...
void test_wm_agent_upgrade_process_upgrade_custom_command(void **state)
{
    ...
    cJSON_AddStringToObject(task_response1, "error", GM_UPGRADE_SUCCESS);
    cJSON_AddStringToObject(task_response1, "message", upgrade_error_codes[GM_UPGRADE_SUCCESS]);
    ...
    cJSON_AddNumberToObject(task_response2, "error", GM_UPGRADE_GLOBAL_DB_FAILURE);
    cJSON_AddStringToObject(task_response2, "message", upgrade_error_codes[GM_UPGRADE_GLOBAL_DB_FAILURE]);
    ...
    expect_string(__wrap_wm_agent_upgrade_validate_version, guardsarm_version, "v3.13.1");
    expect_string(__wrap_wm_agent_upgrade_validate_version, platform, "ubuntu");
    expect_value(__wrap_wm_agent_upgrade_validate_version, command, GM_UPGRADE_UPGRADE_CUSTOM);
    will_return(__wrap_wm_agent_upgrade_validate_version, GM_UPGRADE_SUCCESS);
    ...
    expect_value(__wrap_wm_agent_upgrade_parse_data_response, error_id, GM_UPGRADE_GLOBAL_DB_FAILURE);
    expect_string(__wrap_wm_agent_upgrade_parse_data_response, message, upgrade_error_codes[GM_UPGRADE_GLOBAL_DB_FAILURE]);
    ...
    char *result = gm_agent_upgrade_process_upgrade_custom_command(agents, upgrade_custom_task);
...
void test_wm_agent_upgrade_process_upgrade_custom_command_no_agents(void **state)
{
    ...
    cJSON_AddNumberToObject(task_response1, "error", GM_UPGRADE_GLOBAL_DB_FAILURE);
    cJSON_AddStringToObject(task_response1, "message", upgrade_error_codes[GM_UPGRADE_GLOBAL_DB_FAILURE]);
    cJSON_AddNumberToObject(task_response1, "agent", agents[0]);
...
void test_wm_agent_upgrade_process_upgrade_command(void **state)
{
    ...
    expect_string(__wrap_wm_agent_upgrade_validate_version, guardsarm_version, "v3.13.1");
    expect_string(__wrap_wm_agent_upgrade_validate_version, platform, "ubuntu");
    expect_value(__wrap_wm_agent_upgrade_validate_version, command, GM_UPGRADE_UPGRADE);
    will_return(__wrap_wm_agent_upgrade_validate_version, "v4.1.0");
    will_return(__wrap_wm_agent_upgrade_validate_version, GM_UPGRADE_SUCCESS);
    ...
    expect_value(__wrap_wm_agent_upgrade_parse_task_module_request, command, GM_UPGRADE_UPGRADE);
    will_return(__wrap_wm_agent_upgrade_parse_task_module_request, request_json);
    ...
    char *result = gm_agent_upgrade_process_upgrade_command(agents, upgrade_task);

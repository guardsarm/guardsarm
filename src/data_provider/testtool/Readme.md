...
## Index
1. [Purpose](#purpose)
2. [Compile GuardSarm](#compile-guardsarm)
...
## Compile GuardSarm
In order compile the solution on a specific guardsarm target, the project needs to be built either in os_kernel_release or debug mode.
```

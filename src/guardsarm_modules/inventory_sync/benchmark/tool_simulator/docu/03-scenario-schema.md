...
| --------------------- | -------------------------------- | ------------------------ | ----------------------------------- |
| `package`             | `syscollector_package.json`      | `syscollector_packages`  | `guardsarm-states-inventory-packages`   |
| `system`              | `syscollector_system.json`       | `syscollector_system`    | `guardsarm-states-inventory-system`     |
| `hotfix`              | `syscollector_hotfix.json`       | `syscollector_hotfixes`  | `guardsarm-states-inventory-hotfixes`   |
| `fim_file`            | `fim_file.json`                  | `fim_files`              | `guardsarm-states-fim-files`            |
| `fim_file_windows`    | `fim_file_windows.json`          | `fim_files`              | `guardsarm-states-fim-files`            |
| `fim_registry_key`    | `fim_registry_key.json`          | `fim_registries_keys`    | `guardsarm-states-fim-registries-keys`  |
| `fim_registry_value`  | `fim_registry_value.json`        | `fim_registries_values`  | `guardsarm-states-fim-registries-values`|
| `sca_check`           | `sca_check.json`                 | `sca`                    | `guardsarm-states-sca`                  |
...
```json
{
  "metadata": {
    ...
    "option":  "Sync" | "VDFirst" | "VDSync",
    "indices": ["guardsarm-states-inventory-packages", "..."]
  },
  "items": [
    {
      "seq": 0,
      ...
      "id":    "doc-id-1",
      "index": "guardsarm-states-inventory-packages",

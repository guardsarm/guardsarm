...
def test_configuration_location(test_configuration, test_metadata, truncate_monitored_files, configure_local_internal_options,
                                remove_all_localfiles_guardsarm_config, set_guardsarm_configuration, daemons_handler, wait_for_logcollector_start):
    '''
    description: Check if the 'guardsarm-logcollector' daemon starts properly when the 'journald' tag is used and read the logs from the 'systemd/journald' component.
    ...
    assertions:
        ...
        - Verify that the GuardSarm component (agent or manager) can read the logs from the 'systemd-journald'.

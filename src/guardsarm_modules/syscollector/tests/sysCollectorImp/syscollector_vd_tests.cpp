...
TEST_F(SyscollectorVDTest, VDIndexMapping_SystemToOSInfo)
{
    ...
    EXPECT_STREQ("guardsarm-states-inventory-system", SYSCOLLECTOR_SYNC_INDEX_SYSTEM);
...
TEST_F(SyscollectorVDTest, VDIndexMapping_PackagesToPackages)
{
    ...
    EXPECT_STREQ("guardsarm-states-inventory-packages", SYSCOLLECTOR_SYNC_INDEX_PACKAGES);
...
TEST_F(SyscollectorVDTest, VDIndexMapping_HotfixesToHotfixes)
{
    ...
    EXPECT_STREQ("guardsarm-states-inventory-hotfixes", SYSCOLLECTOR_SYNC_INDEX_HOTFIXES);

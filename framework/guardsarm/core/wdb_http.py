...
class GuardSarmDBHTTPClient:
    ...
    def __init__(self, retries: int = 5, timeout: float = 10):
        ...
        try:
            ...
            raise GuardSarmInternalError(2011, e)

    async def close(self) -> None:
        """Close the guardsarm-manager-db HTTP client."""
    ...
    async def _get(self, endpoint: str) -> Any:
        ...
        try:
            ...
            if response.is_error:
                raise GuardSarmError(2012, extra_message=response.text)
...
@asynccontextmanager
async def get_wdb_http_client() -> AsyncIterator[GuardSarmDBHTTPClient]:
    """Create and return the engine client.

    Returns
    -------
    AsyncIterator[GuardSarmDBHTTP]
        GuardSarm DB HTTP client iterator.
    """
    ...
    try:
        ...
        raise GuardSarmInternalError(2014)
    except UnsupportedProtocol:
        raise GuardSarmInternalError(2015)
    except ConnectError:
        raise GuardSarmInternalError(2016)
    finally:
        await client.close()

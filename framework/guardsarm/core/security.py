...
from guardsarm.rbac.orm import TokenManager, check_database_integrity, DB_FILE
...
def update_security_conf(new_config: dict):
    ...
    if new_config:
        try:
            ...
            raise GuardSarmInternalError(1005)
    else:
        raise GuardSarmError(4021)

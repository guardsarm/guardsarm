...
from guardsarm.core.utils import GuardSarmDBQuery, GuardSarmDBBackend, get_date_from_timestamp
...
class GuardSarmDBQueryTask(GuardSarmDBQuery):
    ...
    def __init__(self, offset: int = 0, limit: int = common.DATABASE_LIMIT, query: str = '', count: bool = True,
                 ...
                 filters: dict = None):
        """Create an instance of GuardSarmDBQueryTasks query.
        ...
        GuardSarmDBQuery.__init__(self, offset=offset, limit=limit, table=table, sort=sort, search=search, select=select,
                              ...
                              min_select_fields=min_select_fields, backend=GuardSarmDBBackend(query_format='task'))

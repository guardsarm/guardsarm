...
void test_sync_keys_with_wdb_insert(void **state) {
    ...
    expect_string(__wrap__mtdebug2, tag, "guardsarm-manager-modulesd:database");
    ...
    expect_string(__wrap__mtdebug1, tag, "guardsarm-manager-modulesd:database");
...
void test_sync_keys_with_wdb_null(void **state) {
    ...
    expect_string(__wrap__mterror, tag, "guardsarm-manager-modulesd:database");

...
def test_agentd_reconection_enrollment_no_keys_file(test_metadata, set_guardsarm_configuration, configure_local_internal_options, truncate_monitored_files, remove_keys_file, daemons_handler):
    '''

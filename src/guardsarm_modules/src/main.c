...
#ifdef CLIENT
    int nofile = getDefine_Int("guardsarm_modules", "rlimit_nofile", 8192, 1048576);
#else
    int nofile = getDefine_Int_default("guardsarm_modules", "rlimit_nofile", 8192, 1048576, 8192);
#endif
...
void wm_handler(int signum)
{
    ...
    case SIGINT:
    case SIGTERM:
        mdebug1("Shutting down GuardSarm modules.");

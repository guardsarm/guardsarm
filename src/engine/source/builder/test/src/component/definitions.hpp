...
public:
    ...
    void initializeBuilder()
    {
        ...
        ON_CALL(*m_spMocks->m_spSchemf, hasField(DotPath("guardsarm.message"))).WillByDefault(testing::Return(true));
        ...
        builderDeps.logpar =
            std::make_shared<hlp::logpar::Logpar>(json::Json {GUARDSARM_LOGPAR_TYPES_JSON}, m_spMocks->m_spSchemf);
        ...
        // Configure MockStore to return a valid IOC configuration for enrichment/ioc/0

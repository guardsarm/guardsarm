...
brief: These tests will check if the 'CORS' (Cross-origin resource sharing) feature of the API handled
       by the 'guardsarm-manager-apid' daemon is working properly. The GuardSarm API is an open source 'RESTful' API
       that allows for interaction with the GuardSarm manager from a web browser, command line tool
...
references:
    ...
    - https://documentation.guardsarmsiem.com/current/user-manual/api/configuration.html#cors

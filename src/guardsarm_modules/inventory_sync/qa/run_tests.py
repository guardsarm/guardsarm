...
Examples:
  ...
  python run_tests.py --manager 127.0.0.1 --port 1514 --registration-port 1515
    ...
    parser.add_argument(
        "--manager", 
        default="127.0.0.1", 
        help="GuardSarm manager IP address (default: 127.0.0.1)"
    )
    parser.add_argument(
        "--port", 
        type=int, 
        default=1514, 
        help="GuardSarm manager communication port (default: 1514)"
    )
    parser.add_argument(
        "--registration-port", 
        type=int, 
        default=1515, 
        help="GuardSarm manager registration port (default: 1515)"
    )
    parser.add_argument(
        "--test", 

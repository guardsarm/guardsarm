/*
 * GuardSarm DB helper module for agents database
 ...
 * current time.
 * @param[in] sock The GuardSarm DB socket connection. If NULL, a new connection will be created and closed locally.
 ...
 * This method creates and sends a command to GuardSarmDB to receive the ID of every agent.
 ...
 * This method creates and sends a command to GuardSarmDB to set as disconnected all the

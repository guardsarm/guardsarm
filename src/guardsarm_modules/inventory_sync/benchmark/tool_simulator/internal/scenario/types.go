...
var PayloadKinds = map[PayloadKind]PayloadKindMeta{
	"package":            {"syscollector_package.json", "syscollector", "guardsarm-states-inventory-packages"},
	"system":             {"syscollector_system.json", "syscollector", "guardsarm-states-inventory-system"},
	"hotfix":             {"syscollector_hotfix.json", "syscollector", "guardsarm-states-inventory-hotfixes"},
	"fim_file":           {"fim_file.json", "fim", "guardsarm-states-fim-files"},
	"fim_file_windows":   {"fim_file_windows.json", "fim", "guardsarm-states-fim-files"},
	"fim_registry_key":   {"fim_registry_key.json", "fim", "guardsarm-states-fim-registry-keys"},
	"fim_registry_value": {"fim_registry_value.json", "fim", "guardsarm-states-fim-registry-values"},

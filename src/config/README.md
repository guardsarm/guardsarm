# GuardSarm configurations

GuardSarm manager and agent configuration are managed and disposed to each module or system component in different ways.
...
This module uses configuration from XML file "gsmsec.conf" section "vulnerability-detection".
...
This module uses configuration from XML file "gsmsec.conf" section "indexer".

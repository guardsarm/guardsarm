...
int w_is_worker(void) {
    OS_XML xml;
    const char * xmlf[] = {GUARDSARMCONFIG, "cluster", NULL};
    const char * xmlf2[] = {GUARDSARMCONFIG, "cluster", "node_type", NULL};
    const char *cfgfile = GUARDSARMCONF;
...
char *get_master_node(void) {
    OS_XML xml;
    const char * xmlf[] = {GUARDSARMCONFIG, "cluster", "nodes", "node", NULL};
    const char *cfgfile = GUARDSARMCONF;
...
char *get_node_name(void) {
    OS_XML xml;
    const char * xmlf[] = {GUARDSARMCONFIG, "cluster", "node_name", NULL};
    const char *cfgfile = GUARDSARMCONF;
    char *node_name = NULL;
...
char *get_cluster_name(void) {
    OS_XML xml;
    const char * xmlf[] = {GUARDSARMCONFIG, "cluster", "name", NULL};
    const char *cfgfile = GUARDSARMCONF;

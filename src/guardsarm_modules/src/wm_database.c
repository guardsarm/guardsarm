...
wmodule* wm_database_read() {
    ...
    data.real_time = getDefine_Int("guardsarm_database", "real_time", 0, 1);
    data.interval = getDefine_Int("guardsarm_database", "interval", 0, 86400);
    data.max_queued_events = getDefine_Int("guardsarm_database", "max_queued_events", 0, INT_MAX);
#else
    data.sync_agents = getDefine_Int_default("guardsarm_database", "sync_agents", 0, 1, 1);
    data.real_time = getDefine_Int_default("guardsarm_database", "real_time", 0, 1, 1);
    data.interval = getDefine_Int_default("guardsarm_database", "interval", 0, 86400, 60);
    data.max_queued_events = getDefine_Int_default("guardsarm_database", "max_queued_events", 0, INT_MAX, 0);
#endif

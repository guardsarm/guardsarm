...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        ...
        TermT(R"($field>=123.32)",
              makeSuccess<HelperToken>(HelperToken {"number_greater_or_equal", Reference("field"), {val(R"(123.32)")}},
                                       14)),
        TermT(R"($field>123)",
              makeSuccess<HelperToken>(HelperToken {"number_greater", Reference("field"), {val(R"(123)")}}, 10)),
        TermT(R"($field<="123")",
        ...
        TermT(R"($field >= 123.32)",
              makeSuccess<HelperToken>({"number_greater_or_equal", Reference("field"), {val(R"(123.32)")}}, 16)),
        TermT(R"($field > 123)", makeSuccess<HelperToken>({"number_greater", Reference("field"), {val(R"(123)")}}, 12)),
        TermT(R"($field <= "123")",
        ...
        TermT(R"($field   >=123.32)",
              makeSuccess<HelperToken>({"number_greater_or_equal", Reference("field"), {val(R"(123.32)")}}, 17)),
        TermT(R"($field   >123)",
              makeSuccess<HelperToken>({"number_greater", Reference("field"), {val(R"(123)")}}, 13)),
        TermT(R"($field   <="123")",
        ...
        TermT(R"($field==   true)", makeSuccess<HelperToken>({"filter", Reference("field"), {val(R"(true)")}}, 15)),
        TermT(R"($field>=   123)",
              makeSuccess<HelperToken>({"number_greater_or_equal", Reference("field"), {val(R"(123)")}}, 14)),
        TermT(R"($field>    123.32)",
              makeSuccess<HelperToken>({"number_greater", Reference("field"), {val(R"(123.32)")}}, 17)),
        TermT(R"($field<=   "123")",
              makeSuccess<HelperToken>({"string_less_or_equal", Reference("field"), {val(R"("123")")}}, 16)),
        TermT(R"($field<   "123")",
              makeSuccess<HelperToken>({"string_less", Reference("field"), {val(R"("123")")}}, 15)),
        ...
        TermT(R"($field==    {"key_str":"asd","key_num":123,"key_obj":{"custom_key":true}})",
              makeSuccess<HelperToken>({"filter",
                                        ...
                                        {val(R"({"key_str":"asd","key_num":123,"key_obj":{"custom_key":true}})")}},
                                       73)),
        TermT(R"($field->123)", makeSuccess<HelperToken>({"number_greater", Reference("field-"), {val(R"(123)")}}, 11)),
        ...
        TermT(R"(hp($guardsarm.protocol.queue) )", makeSuccess<HelperToken>({"hp", Reference("guardsarm.protocol.queue")}, 25)),
        TermT(R"(hp($guardsarm.protocol.queue) ())", makeSuccess<HelperToken>({"hp", Reference("guardsarm.protocol.queue")}, 25)),
        TermT(R"(hp($guardsarm.protocol.queue)==())", makeSuccess<HelperToken>({"hp", Reference("guardsarm.protocol.queue")}, 25)),
        TermT(R"(hp($guardsarm.protocol.queue) AND)", makeSuccess<HelperToken>({"hp", Reference("guardsarm.protocol.queue")}, 25)),
        TermT(R"(hp($guardsarm.protocol.queue)==)", makeSuccess<HelperToken>({"hp", Reference("guardsarm.protocol.queue")}, 25)),
        TermT(R"(hp($guardsarm.protocol.queue)!!)", makeSuccess<HelperToken>({"hp", Reference("guardsarm.protocol.queue")}, 25)),
        TermT(R"(hp($guardsarm.protocol.queue)>)", makeSuccess<HelperToken>({"hp", Reference("guardsarm.protocol.queue")}, 25)),
        TermT(R"(hp($guardsarm.protocol.queue, ,\ \,) )",
              makeSuccess<HelperToken>({"hp", Reference("guardsarm.protocol.queue"), {val(), val(R"(" ,")")}}, 32)),
        TermT(R"(hp($guardsarm.protocol.queue, ,\ \,) ())",
              makeSuccess<HelperToken>({"hp", Reference("guardsarm.protocol.queue"), {val(), val(R"(" ,")")}}, 32)),
        TermT(R"(hp($guardsarm.protocol.queue, ,\ \,)==())",
              makeSuccess<HelperToken>({"hp", Reference("guardsarm.protocol.queue"), {val(), val(R"(" ,")")}}, 32)),
        TermT(R"(hp($guardsarm.protocol.queue, ,\ \,) AND)",
              makeSuccess<HelperToken>({"hp", Reference("guardsarm.protocol.queue"), {val(), val(R"(" ,")")}}, 32)),
        TermT(R"(hp($guardsarm.protocol.queue, ,\ \,)==)",
              makeSuccess<HelperToken>({"hp", Reference("guardsarm.protocol.queue"), {val(), val(R"(" ,")")}}, 32)),
        TermT(R"(hp($guardsarm.protocol.queue, ,\ \,)!!)",

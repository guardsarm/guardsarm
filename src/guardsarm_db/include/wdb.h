 ...
 *
 * @param [in] input The chunk obtained from GuardSarmDB to be parsed.
...
/**
 * @brief Function to get the information of a particular agent stored in GuardSarm DB.
 *
 * @param wdb The Global struct database.
 * @param id Agent id.
...
/**
 * @brief Method to read the internal guardsarm-db configuration.
 *

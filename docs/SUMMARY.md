...
- [Configuration](ref/configuration/README.md)
  - [Global](ref/configuration/global.md)
  - [Logging](ref/configuration/logging.md)
  - [Remote](ref/configuration/remote.md)
  - [Auth](ref/configuration/auth.md)
  - [Indexer](ref/configuration/indexer.md)
  - [Vulnerability Detection](ref/configuration/vulnerability-detection.md)
  - [Socket](ref/configuration/socket.md)
  - [Agent Upgrade / Task Manager](ref/configuration/agent-upgrade.md)
  - [GuardSarm-DB](ref/configuration/guardsarm-db.md)
  - [Cluster](ref/configuration/cluster.md)
  - [Wodle: Command](ref/configuration/wodle-command.md)
  - [Wodle: Docker Listener](ref/configuration/wodle-docker.md)
- [Modules](ref/modules/README.md)
  - [Active Response](ref/modules/active-response/README.md)
    ...
    - [Executables Reference](ref/modules/active-response/executables.md)
  - [Agent Info](ref/modules/agent_info/README.md)
    - [Architecture](ref/modules/agent_info/architecture.md)
    - [Configuration](ref/modules/agent_info/configuration.md)
    - [API Reference](ref/modules/agent_info/api-reference.md)
    - [Database Schema](ref/modules/agent_info/database-schema.md)
  - [Agent Management](ref/modules/agent-management/README.md)
    - [Centralized Configuration](ref/modules/agent-management/centralized-configuration.md)
    - [Agent Groups](ref/modules/agent-management/agent-groups.md)
  - [Integrations](ref/modules/integrations/README.md)
    - [GCP](ref/modules/integrations/gcp.md)
    - [AWS CloudTrail](ref/modules/integrations/aws-cloudtrail.md)
    - [AWS CloudWatch Logs](ref/modules/integrations/aws-cloudwatch-logs.md)
    - [AWS Security Hub](ref/modules/integrations/aws-security-hub.md)
    - [Amazon Security Lake](ref/modules/integrations/amazon-security-lake.md)
    - [Office 365](ref/modules/integrations/office365.md)
    ...
    - [Docker Listener](ref/modules/integrations/docker.md)
  ...
  - [Rootcheck](ref/modules/rootcheck/README.md)
    ...
    - [Output Samples](ref/modules/rootcheck/output-samples.md)
  ...
  - [Control](ref/modules/control/README.md)
    - [Architecture](ref/modules/control/architecture.md)
  - [Inventory Sync](ref/modules/inventory-sync/README.md)
    ...
    - [Test Tools](ref/modules/inventory-sync/test-tools.md)
  ...
  - [Server API](ref/modules/server-api/README.md)
    - [Architecture](ref/modules/server-api/architecture.md)
    - [API Reference](ref/modules/server-api/api-reference.md)
    - [Authentication](ref/modules/server-api/authentication.md)
    - [Configuration](ref/modules/server-api/configuration.md)
    - [Testing](ref/modules/server-api/testing.md)
  - [Agent Sync Protocol](ref/modules/utils/sync-protocol/README.md)
    ...
    - [Persistence Performance](ref/modules/utils/sync-protocol/persistence-performance.md)
  - [Schema Validator](ref/modules/utils/schema-validator/README.md)
    - [API Reference](ref/modules/utils/schema-validator/api-reference.md)
    - [Integration Guide](ref/modules/utils/schema-validator/integration-guide.md)
  ...
  - [GuardSarm DB](ref/modules/guardsarm_db/README.md)

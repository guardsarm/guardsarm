...
/**
 * Function with all the necessary functionality to process the uninstallation validation of the GuardSarm agent package.
...
static const char AG_IN_UNMERGE[] = "guardsarm: Could not unmerge shared file.";

Feature: Tester API Management
  ...
  Scenario: Add a repeated session for testing via API
    Given I have a policy "testing" that has an integration called "guardsarm-core-test" loaded
  ...
  Scenario: Change sync to OUTDATED of specific session via API
    Given I have a policy "testing" that has an integration called "guardsarm-core-test" loaded
    And I create a "default" session that points to policy "testing"
    When I send a request to the policy "testing" to add an integration called "other-guardsarm-core-test"
  ...
  Scenario: Send events to specific session without debug session via API
    Given I have a policy "testing" that has an integration called "other-guardsarm-core-test" loaded
    ...
    Then I should receive the next output: "{"output":{"guardsarm":{"agent":{"name":"agent-ex","id":"001ASD"},"protocol":{"location":"[001ASD] (agent-ex) any->SomeModule","queue":49},"space":{"name":"UNDEFINED"}},"event":{"original":"hi! i am an event test!"}}}"
  ...
  Scenario: Send events to specific session with low debug via API
      ...
      Then I should receive the next output: "{"assetTraces":[{"asset":"decoder/other-test-message/0","success":true}],"output":{"guardsarm":{"agent":{"id":"BB22","name":"agent-ex"},"integration":{"category":"other","decoders":["decoder/other-test-message/0"],"name":"other-guardsarm-core-test"},"protocol":{"location":"[BB22] (agent-ex) any->SomeModule","queue":49},"space":{"name":"UNDEFINED"}},"event":{"category":["test"],"kind":"metric","original":"hi! i am an event test!","type":["info"]}}}"
  ...
  Scenario: Send events to specific session with high debug via API
      ...
      Then I should receive the next output: "{"assetTraces":[{"asset":"decoder/other-test-message/0","success":true,"traces":["[check: $guardsarm.agent.id == BB22] -> Success","event.category: array_append(\"test\") -> Success","event.kind: map(\"metric\") -> Success","event.type: array_append(\"info\") -> Success"]}],"output":{"guardsarm":{"agent":{"id":"BB22","name":"agent-ex"},"integration":{"category":"other","decoders":["decoder/other-test-message/0"],"name":"other-guardsarm-core-test"},"protocol":{"location":"[BB22] (agent-ex) any->SomeModule","queue":49},"space":{"name":"UNDEFINED"}},"event":{"category":["test"],"kind":"metric","original":"hi! i am an event test!","type":["info"]}}}"
  ...
  Scenario: Send events to specific session with high debug with unclassified event via API
      ...
      Then I should receive the next output: "{"assetTraces":[{"asset":"decoder/other-test-message/0","success":true,"traces":["[check: $guardsarm.agent.id == BB22] -> Success","event.category: array_append(\"test\") -> Success","event.kind: map(\"metric\") -> Success","event.type: array_append(\"info\") -> Success"]},{"asset":"filter/DiscardedEvents","success":true,"traces":["Discard_event() -> Success: Event will be indexed (guardsarm.space.event_discarded=false)"]},{"asset":"cleanup/DecoderTemporaryVariables","success":true,"traces":["cleanupDecoderTemporaryVariables() -> Success: Removed root keys prefixed with '_'"]}],"output":{"guardsarm":{"agent":{"id":"BB22","name":"agent-ex"},"integration":{"category":"other","decoders":["decoder/other-test-message/0"],"name":"other-guardsarm-core-test"},"protocol":{"location":"[BB22] (agent-ex) any->SomeModule","queue":49},"space":{"name":"UNDEFINED"}},"event":{"category":["test"],"kind":"metric","original":"hi! i am an event test!","type":["info"]}}}"
  ...
  Scenario: Send events without agent metadata - empty struct assumed
      ...
      Then I should receive the next output: "{"output":{"guardsarm":{"protocol":{"location":"[] () any->SomeModule","queue":49},"space":{"name":"UNDEFINED"}},"event":{"original":"hi! i am an event test!"}}}"
  ...
  Scenario: Send events with custom agent metadata fields
      ...
      Then I should receive the next output: "{"assetTraces":[{"asset":"decoder/other-test-message/0"}],"output":{"guardsarm":{"agent":{"id":"CUSTOM123","name":"custom-agent","type":"endpoint"},"protocol":{"location":"[CUSTOM123] (custom-agent) any->SomeModule","queue":49},"space":{"name":"UNDEFINED"}},"event":{"original":"hi! i am an event test!"}}}"

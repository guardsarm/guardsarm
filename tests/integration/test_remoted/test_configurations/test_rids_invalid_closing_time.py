...
def test_rids_closing_time_invalid(test_configuration, test_metadata, configure_local_internal_options, truncate_monitored_files,
                            set_guardsarm_configuration, restart_guardsarm_expect_error, capsys):

    '''
    description: Check if 'guardsarm-manager-remoted' fails when an invalid 'rids_closing_time' value is set. For this purpose,
